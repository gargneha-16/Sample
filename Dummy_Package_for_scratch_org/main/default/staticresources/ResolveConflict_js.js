            ...
            if (((attach && attach.Body.length > 0) || preFlag) && !returnFlag) {
                ...
                if (panes != 1) {
                    ...
                    $copado('.CodeMirror-merge-editor').prepend(
                        '<div class="panel top" style="background-color:white;"><center><div id="resolutionToolTip" class="slds-popover slds-popover_tooltip slds-nubbin_top-left slds-is-absolute slds-hide toolTipTopHeight" role="tooltip"><div class="slds-popover__body"><div><span>' +
                            resolutionToolTip +
                            ...
                            (attach
                                ? resolution +
                                  ...
                                  '</center></div>'
                                : source + jqxdatatable_config.data.orgName)
                    );
                    $copado('.CodeMirror-merge-pane-rightmost').prepend(
                        '<div class="panel top" style="background-color:white;"><center><div id="featureToolTip" class="slds-popover slds-popover_tooltip slds-nubbin_top slds-is-absolute slds-hide toolTipTopHeight" role="tooltip"><div class="slds-popover__body"><div><span>' +
                            featureToolTip +
                            '</span></div></div></div><span>' +
                            (attach
                                ? featureBranch +
                                  ...
                                  '</center></div>'
                                : target + jqxdatatable_config.data.targetOrgName)
                    );
                    if ($copado('.CodeMirror-merge-left').length > 0) {
                        $copado('.CodeMirror-merge-left').prepend(
                            '<div class="panel top" style="background-color:white;"><center><div id="promotionToolTip" class="slds-popover slds-popover_tooltip slds-nubbin_top slds-is-absolute slds-hide toolTipTopHeight" role="tooltip"><div class="slds-popover__body"><div><span>' +
                                promotionToolTip +
                                '</span></div></div></div><span>' +
                                promotionBranch +
                                '</span>' +
                    ...
                    editor2.focus();
                    var value = attach ? Base64.decode(attach.Body): prapareValue(preSource[0], format);
