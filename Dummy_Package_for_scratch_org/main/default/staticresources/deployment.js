...
var copadoStep = {
    ...
    showBlockByType: function (type) {
        ...
        if (type == 'MetaData' || type == 'Git MetaData' || type == 'Git Promotion') {
            ...
            $copado('[id=btn-js-rollbackwizard]').show();
    ...
    hideAll: function () {
        $copado(
            '[id=js-FindReplaceContainer],[id=js-stepBlock-UrlCallout-ResumeUrl],[id$=js-stepBlock-UrlCallout],[id=js-TestLevelContainer],[id$=js-stepBlock-ManualTask],[id$=js-stepBlock-Apex],[id$=pbStepDetailComponent],[id$=btn-js-rollbackwizard],[id$=js-stepBlock-Grid],[id$=js-stepBlock-Users],[id$=js-stepBlock-QB],[id$=js-stepBlock-CustomSettings],[id$=js-stepBlock-QuickActions],[id$=js-stepBlock-Git-MetaData],[id$=js-stepBlock-Git-Promotion],[Id$=js-stepBlock-ExternalCI],[Id$=js-stepBlock-DataTemplate],[Id$=js-stepBlock-SalesforceFlow],[Id$=js-stepBlock-Function],[Id$=js-stepBlock-Automation]'
        ).hide();
    },
    ...
    redirectToRollbackWizard: function () {
        var namespace = copadoApp.ns != '' ? copadoApp.ns + '__' : '';
